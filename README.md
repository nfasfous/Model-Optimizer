...
- [2026/05/27] [**End-to-end Optimization workflow for Nemotron-3-Nano-30B-A3B**](./examples/megatron_bridge/tutorials/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16): Pruning + two-phase distillation + NVFP4 quantization + QAD - achieving ?× vLLM throughput and ?× memory reduction.
