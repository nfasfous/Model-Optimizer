...
**model-body scheme** (what gets quantized, and to what format) with a
**KV-cache scheme**, optionally with a **calibration variant**:

```text
<model-body>-<kv-cache>[-<calibration>].yaml
